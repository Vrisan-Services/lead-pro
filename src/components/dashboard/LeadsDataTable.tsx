...
const stageBadgeVariant: Record<LeadStage, string> = {
  ...
  Converted: "bg-green-100 text-green-800 hover:bg-green-200 dark:bg-green-900/50 dark:text-green-300",
          ...
          <TableBody>
            {leads.map((lead,index) => (
              <TableRow key={index} className="group transition-colors hover:bg-muted/50" >
                ...
                <TableCell className="hidden sm:table-cell text-muted-foreground">{lead.PCode}-{lead.Phone}</TableCell>
